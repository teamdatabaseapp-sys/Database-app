...
// ============================================
// PromoSectionHeader (matches DripCampaignScreen)
// ============================================

export function PromoSectionHeader({
  icon, title, subtitle, expanded, onToggle, badge,
}: {
  ...
  return (
    ...
    >
      ...
      <View style={{ flex: 1 }}>
        ...
        {subtitle && <Text style={{ color: colors.textTertiary, fontSize: 12, marginTop: 1 }}>{subtitle}</Text>}
      </View>
