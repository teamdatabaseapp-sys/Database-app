-- ============================================
-- UPDATE get_public_booking_config TO INCLUDE STAFF AVATARS
...
-- Recreate function with avatar support
...
BEGIN
  ...
  -- Get active staff WITH avatar URLs (uses 'staff' table)
  SELECT COALESCE(jsonb_agg(
    jsonb_build_object(
      'id', s.id,
      'name', s.name,
...
-- ============================================
SELECT 'get_public_booking_config function updated with avatar support' as status;
