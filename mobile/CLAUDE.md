...
<mistakes>
  ...
  <ux>
    ...
    Ensure keyboard is dismissable and doesn't obscure inputs. Use ScrollView with keyboardShouldPersistTaps="handled" and KeyboardAvoidingView from react-native when needed.
  </ux>
